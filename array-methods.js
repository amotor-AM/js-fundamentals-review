...
let allCaps = [];
let capitalize = runners.map((name) => {
...
let largeShirts = [];
const runnerInfo = runners.filter((shirt, index) => {
...
let ticketPriceTotal = runners.reduce((sum, currentRunner) => {
  return sum + currentRunner.donation;
}, 0);
